...
namespace KsDumper11
{
    public class ProcessSummary
    {
        ...
        // CHANGED: Constructor made Public to allow module dumping
        public ProcessSummary(int processId, ulong mainModuleBase, string mainModuleFileName, uint mainModuleImageSize, ulong mainModuleEntryPoint, bool isWOW64)
        {
